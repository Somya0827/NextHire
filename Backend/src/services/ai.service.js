...
async function generatePdfFromHtml(htmlContent) {
    ...
    const pdfBuffer = await page.pdf({ format: "A4", margin: { top: '20mm', bottom: "20mm", left: '20mm', right: "15mm" } })
    await browser.close()
...
async function generateResumePdf({ resume, selfDescription, jobDescription }) {
    ...
    const prompt = `Generate a resume for a candidate with the follwoing detail :
    Resume : ${resume},
    Self Description : ${selfDescription},
    Job Description : ${jobDescription}
